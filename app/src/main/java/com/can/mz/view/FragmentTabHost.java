...
public class FragmentTabHost extends TabHost
    ...
    private LinearLayout mRealTabContent;
    ...
    private String mLastTabTag = null; //记录上次Tab's tag
    ...
    private void ensureHierarchy(Context context) {
        if (findViewById(android.R.id.tabs) == null) {
            ...
            mRealTabContent = fl = new LinearLayout(context);
    ...
    private void ensureContent() {
        if (mRealTabContent == null) {
            mRealTabContent = (LinearLayout) ((Activity) mContext).findViewById(mContainerId);//todo zhugejiao
            if (mRealTabContent == null) {
                throw new IllegalStateException(
